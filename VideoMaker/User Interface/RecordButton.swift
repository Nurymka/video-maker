...
//            if progressTrack.animationForKey("stroke") == nil || layer.animationForKey("scale") == nil {
//                setupAnimations()
//            }
    ...
    override func commonInit() {
        ...
        progressTrack.strokeColor = StyleKit.lightPurple.CGColor
    ...
    override func layoutSubviews() {
        ...
        progressTrack.path = UIBezierPath(arcCenter: bounds.center, radius: trackRadius, startAngle: -π/2, endAngle: 3/2*π,  clockwise: true).CGPath
    }
    ...
    override func drawRect(rect: CGRect) {
        ...
        let translucentTrackBackground = UIBezierPath(arcCenter: bounds.center, radius: trackRadius, startAngle: 0, endAngle: 2*π, clockwise: true)
        translucentTrackBackground.lineWidth = trackWidth
        StyleKit.translucentBlack.setStroke()
        translucentTrackBackground.stroke()
    }
