...
//    ]
    ...
    enum PlaylistListRouter: URLRequestConvertible {
        static let baseURLString = "http://www.musical.ly/rest/tracks/tags"
        ...
        var URLRequest: NSMutableURLRequest {
            ...
            let URL = NSURL(string: PlaylistListRouter.baseURLString)
            let URLRequest = NSMutableURLRequest(URL: URL!)
            URLRequest.setValue("MTQ1MDYzODM5X3R3aXR0ZXI6OENkbUlMOVlrenBUdy9TengzZklNZz09OmQ4N2U1NzdkYjg3NmRkMzkwYWI1MGU1YTYyNDQ4NDky", forHTTPHeaderField: "slider-show-cookie")
            let encoding = Alamofire.ParameterEncoding.URL
